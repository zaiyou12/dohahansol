...
<div class="embla bg-gray-50">
	...
	<button
		class="absolute left-4 top-1/2 disabled:cursor-not-allowed disabled:opacity-30"
		on:click={prevSection}
	>
		<img
			class="h-[26px] w-[26px] rotate-180"
			src="/carousel-arrow.svg"
			alt="carousel carousel left"
			loading="lazy"
		/>
	</button>
	<button
		class="absolute right-4 top-1/2 disabled:cursor-not-allowed disabled:opacity-30"
		on:click={nextSection}
	>
		<img
			class="h-[26px] w-[26px]"
			src="/carousel-arrow.svg"
			alt="carousel carousel right"
			loading="lazy"
		/>
	</button>
</div>
